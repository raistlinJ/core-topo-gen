...
DROPDOWN_OPTIONS = ["Random", "Option 1", "Option 2", "Option 3"]
...
def edit_scenario(scenario_name):
    ...
    if request.method == "POST":
        # Handle add/remove dropdowns
        # Also parse the form inputs and validate factor sums

        # Copy current data to modify
        new_sections = {}
        ...
        for section in SECTION_NAMES:
            ...
            # Check if add button pressed for this section
